...
const AnimationDirection: React.FC<AnimationDirectionProps> = ({
  ...
  const [alternate, setAlternate] = React.useState<string | null>(
    'alternate'
  );
  ...
  return (
    <div className="input-row">
      ...
      >
        <ToggleButton value="normal" aria-label="forwards" size="small">
          <ArrowForwardIcon />
        </ToggleButton>
        <ToggleButton value="reverse" aria-label="backwards" size="small">
          <ArrowBackIcon />
        </ToggleButton>
      </ToggleButtonGroup>
      <ToggleButtonGroup
