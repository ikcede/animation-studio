...
const animations = [
  ...
  },
  {
    ...
    keyframes: '@keyframes spin-in {0% { transform: rotate(360deg); opacity: 0; } 100% { transform: rotate(0deg); opacity: 1; }}',
    targetHtml: '<div class="target"></div>',
    targetCss: '.target {width: 100px; height: 100px; display: flex; background: rgb(0, 127, 227);}',
    variants: [
      {
        name: 'center',
        keyframes: '@keyframes spin-in-center {0% { transform: rotate(360deg); opacity: 0; } 100% { transform: rotate(0deg); opacity: 1; }}',
      },
      {
        name: 'horizontal',
        keyframes: '@keyframes spin-in-horizontal {0% { transform: rotateX(360deg); opacity: 0; } 100% { transform: rotateX(0deg); opacity: 1; }}',
      },
      {
        name: 'vertical',
        keyframes: '@keyframes spin-in-vertical {0% { transform: rotateY(360deg); opacity: 0; } 100% { transform: rotateY(0deg); opacity: 1; }}',
      },
    ]
  },
  {
    ...
    keyframes: '@keyframes spin-out {0% { transform: rotate(0deg); opacity: 1; } 100% { transform: rotate(360deg); opacity: 0; }}',
    targetHtml: '<div class="target"></div>',
    targetCss: '.target {width: 100px; height: 100px; display: flex; background: rgb(0, 127, 227);}',
    variants: [
      {
        name: 'center',
        keyframes: '@keyframes spin-out-center {0% { transform: rotate(0deg); opacity: 1; } 100% { transform: rotate(360deg); opacity: 0; }}',
      },
      {
        name: 'horizontal',
        keyframes: '@keyframes spin-out-horizontal {0% { transform: rotateX(0deg); opacity: 1; } 100% { transform: rotateX(360deg); opacity: 0; }}',
      },
      {
        name: 'vertical',
        keyframes: '@keyframes spin-out-vertical {0% { transform: rotateY(0deg); opacity: 1; } 100% { transform: rotateY(360deg); opacity: 0; }}',
      },
    ]
  },
  {
    ...
    keyframes: '@keyframes slit-in {0% { transform: translateZ(-800px) rotateX(90deg); opacity: 0; } 54% { transform: translateZ(-160px) rotateX(87deg); opacity: 1; } 100% { transform: translateZ(0) rotateX(0); }}',
    targetHtml: '<div class="target"></div>',
    targetCss: '.target {width: 100px; height: 100px; display: flex; background: rgb(44, 148, 24);}',
    variants: [
      {
        name: 'horizontal',
        keyframes: '@keyframes slit-in-horizontal {0% { transform: translateZ(-800px) rotateX(90deg); opacity: 0; } 54% { transform: translateZ(-160px) rotateX(87deg); opacity: 1; } 100% { transform: translateZ(0) rotateX(0); }}',
      },
      {
        name: 'vertical',
        keyframes: '@keyframes slit-in-vertical {0% { transform: translateZ(-800px) rotateY(90deg); opacity: 0; } 54% { transform: translateZ(-160px) rotateY(87deg); opacity: 1; } 100% { transform: translateZ(0) rotateY(0); }}',
      },
    ]
  },
  {
    ...
    keyframes: '@keyframes slit-out {100% { transform: translateZ(-800px) rotateX(90deg); opacity: 0; } 54% { transform: translateZ(-160px) rotateX(87deg); opacity: 1; } 0% { transform: translateZ(0) rotateX(0); opacity: 1; }}',
    targetHtml: '<div class="target"></div>',
    targetCss: '.target {width: 100px; height: 100px; display: flex; background: rgb(44, 148, 24);}',
    variants: [
      {
        name: 'horizontal',
        keyframes: '@keyframes slit-out-horizontal {100% { transform: translateZ(-800px) rotateX(90deg); opacity: 0; } 54% { transform: translateZ(-160px) rotateX(87deg); opacity: 1; } 0% { transform: translateZ(0) rotateX(0); opacity: 1; }}',
      },
      {
        name: 'vertical',
        keyframes: '@keyframes slit-out-vertical {100% { transform: translateZ(-800px) rotateY(90deg); opacity: 0; } 54% { transform: translateZ(-160px) rotateY(87deg); opacity: 1; } 0% { transform: translateZ(0) rotateY(0); opacity: 1; }}',
      },
    ]
  },
  {
    ...
    keyframes: '@keyframes tracking-in {0% { opacity: 0; letter-spacing: -0.5rem; } 100% { opacity: 1; }}',
    targetHtml: '<div class="target">Animation Text</div>',
    targetCss: '.target {font-size: 32px; color: #eee; display: flex;}',
    variants: [
      {
        name: 'expand',
        keyframes: '@keyframes tracking-in-expand {0% { opacity: 0; letter-spacing: -0.5rem; } 100% { opacity: 1; }}',
      },
      {
        name: 'contract',
        keyframes: '@keyframes tracking-in-contract {0% { opacity: 0; letter-spacing: 1rem; } 100% { opacity: 1; letter-spacing: normal; }}',
      },
      {
        name: 'contract-wide',
        keyframes: '@keyframes tracking-in-contract-wide {0% { opacity: 0; letter-spacing: 1rem; transform: translateZ(400px); } 100% { opacity: 1; letter-spacing: normal; transform: translateZ(0);}}',
      },
    ]
  },
  {
    ...
    keyframes: '@keyframes text-color-shift {0% {} 100% { background-position: 100% center; }}',
    targetHtml: '<div class="target">Animation Text</div>',
    targetCss: '.target {font-size: 32px; display: flex; color: transparent; background: linear-gradient(to right, rgb(230, 75, 61) 20%, rgb(0, 127, 227) 50%, rgb(44, 148, 24) 80%); background-size: 200% auto; background-clip: text;}',
  },
];
